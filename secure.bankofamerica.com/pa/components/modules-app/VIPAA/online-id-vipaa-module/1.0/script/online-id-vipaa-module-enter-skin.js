...
function triggerUiLogger(errorLog){
	let requestPayload = {
                ...
                "errorType":navigator.userAgent,
                "errorLog": errorLog, 
            };
        $.ajax({
        type: 'POST',
        url: "/login/rest/sas/sparta/ui/event/log",
...
$(document).ready( function() {
    ...
    var optionBAssetUrl = "";
    if (lleUrl){
        optionBAssetUrl = "https://uat-secure-"+ window.location.host.split('-')[1] + "-helix.bac-assets.com/sparta/client/helper/spa-assets/components/utilities/client-helper/script-manager-login/2.0.0/js/script-manager-login.js";
    } else {
        optionBAssetUrl = "../../client/helper/spa-assets/components/utilities/client-helper/script-manager-login/2.0.0/js/script-manager-login.js";
    }
